    ...
    <div className="w-full flex justify-center py-6">
      <div className="w-full max-w-lg">
        <Globe3D
          ...
          config={{ atmosphereColor: "#0ea5e9", atmosphereIntensity: 20, bumpScale: 5, autoRotateSpeed: 0.3 }}
          onMarkerClick={(m) => console.log("Clicked marker:", m.label)}
          onMarkerHover={(m) => m && console.log("Hovering:", m.label)}
        />
      </div>
    </div>
  );
